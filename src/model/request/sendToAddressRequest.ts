...
export interface SendToAddressRequest { 
    /**
     * The vircle address to send to.
     */
    vircleaddress: string;
    /**
    ...
    commentto?: string;
    /**
     * The fee will be deducted from the amount being sent. The recipient will receive less vircles than you enter in the amount field.
     */
